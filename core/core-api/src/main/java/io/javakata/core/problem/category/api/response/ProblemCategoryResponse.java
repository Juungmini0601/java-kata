...
@Builder
public record ProblemCategoryResponse(Long id, String categoryName, LocalDateTime createdAt, LocalDateTime updatedAt) {
    public static ProblemCategoryResponse from(ProblemCategory problemCategory) {
        return builder().id(problemCategory.getId())
